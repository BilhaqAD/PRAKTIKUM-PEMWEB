<?php
// Gabung file dengan connect.php
include 'connect.php';
?>
...
<body>
	...
	<div class="wrapper">
		...
		<div class="form">
			<label>Keyword</label>
			<input type="text" name="s_keyword" id="s_keyword" class="form-control" placeholder="ex: Anonymous">
		</div>
	</div>
    ...
    <footer align="center">© <?php echo date('Y'); ?> Copyright: 
	<a href="https://github.com/BilhaqAD">BAD</a>
	</footer>
